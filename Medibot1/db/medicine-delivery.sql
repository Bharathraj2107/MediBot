...
INSERT INTO `medicines` VALUES (1,'Krocin',6.00),(2,'Dolo 650',7.00),(3,'Doloper',8.00),(4,'B12',5.00),(5,'Sinarest',6.00),(6,'Benzonatate',9.00),(7,'Aspirin capsules',4.00),(8,'Nimesulide',7.00),(9,'Vicks',5.00);
...
CREATE TABLE `orders` (
  ...
  CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `medicines` (`item_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
BEGIN
    ...
    -- Check if the item_name exists in the medicines table
    IF (SELECT COUNT(*) FROM medicines WHERE name = p_item_name) > 0 THEN
...
BEGIN
    ...
    -- Get the item_id and price for the medicine
    SET v_item_id = (SELECT item_id FROM food_items WHERE name = p_medicine);
    SET v_price = (SELECT get_price_for_item(p_medicine));
